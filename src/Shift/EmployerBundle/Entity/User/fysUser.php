...
namespace Shift\EmployerBundle\Entity\User;
 ...
 * fysUser
 *
 * @ORM\Table(name="userfys_user")
 * @ORM\Entity(repositoryClass="Shift\EmployerBundle\Repository\User\fysUserRepository")
 */
class fysUser
{
    /**
